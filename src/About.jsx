          ...
          <div className="col-md-4">
            <div className="card mb-4">
              <div className="card-body text-center">
                ...
                <p className="card-text" style={{ color: 'black' }}>We believe in the power of community and collaboration.</p>
              </div>
            </div>
          </div>
          <div className="col-md-4">
            <div className="card mb-4">
              <div className="card-body text-center">
                <h5 className="card-title" style={{ color: 'black' }}>Compassion</h5>
                <p className="card-text" style={{ color: 'black' }}>Helping those in need is at the heart of what we do.</p>
              </div>
            </div>
          </div>
          <div className="col-md-4">
            <div className="card mb-4">
              <div className="card-body text-center">
                <h5 className="card-title" style={{ color: 'black' }}>Integrity</h5>
                <p className="card-text" style={{ color: 'black' }}>We operate with transparency and honesty.</p>
              </div>
            </div>
          </div>
        </div>
